var gridOptions = {
    ...
    columnDefs: [
        ...
        {headerName: 'Sport', field: 'sport'},        // using number column type
        {headerName: 'Age', field: 'age', type: 'numberColumn'},
        {headerName: 'Year', field: 'year', type: 'numberColumn'},        // using date and non-editable column types
    ...
    columnTypes: {
        ...
        dateColumn: {
            ...
            filter: 'agDateColumnFilter',            // add extra parameters for the date filter
            filterParams: {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new agGrid.Grid(gridDiv, gridOptions);    agGrid.simpleHttpRequest({url: 'https://raw.githubusercontent.com/ag-grid/ag-grid/master/packages/ag-grid-docs/src/olympicWinnersSmall.json'}).then(function(data) {
